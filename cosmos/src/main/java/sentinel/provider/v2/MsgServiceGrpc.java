...
public final class MsgServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sentinel.provider.v2.Msg.MsgRegisterRequest,
      sentinel.provider.v2.Msg.MsgRegisterResponse> getMsgRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgRegister",
      requestType = sentinel.provider.v2.Msg.MsgRegisterRequest.class,
      responseType = sentinel.provider.v2.Msg.MsgRegisterResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sentinel.provider.v2.Msg.MsgRegisterRequest,
      sentinel.provider.v2.Msg.MsgRegisterResponse> getMsgRegisterMethod() {
    io.grpc.MethodDescriptor<sentinel.provider.v2.Msg.MsgRegisterRequest, sentinel.provider.v2.Msg.MsgRegisterResponse> getMsgRegisterMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgRegisterMethod = MsgServiceGrpc.getMsgRegisterMethod) == null) {
          MsgServiceGrpc.getMsgRegisterMethod = getMsgRegisterMethod =
              io.grpc.MethodDescriptor.<sentinel.provider.v2.Msg.MsgRegisterRequest, sentinel.provider.v2.Msg.MsgRegisterResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgRegister"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.provider.v2.Msg.MsgRegisterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.provider.v2.Msg.MsgRegisterResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<sentinel.provider.v2.Msg.MsgUpdateRequest,
      sentinel.provider.v2.Msg.MsgUpdateResponse> getMsgUpdateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgUpdate",
      requestType = sentinel.provider.v2.Msg.MsgUpdateRequest.class,
      responseType = sentinel.provider.v2.Msg.MsgUpdateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sentinel.provider.v2.Msg.MsgUpdateRequest,
      sentinel.provider.v2.Msg.MsgUpdateResponse> getMsgUpdateMethod() {
    io.grpc.MethodDescriptor<sentinel.provider.v2.Msg.MsgUpdateRequest, sentinel.provider.v2.Msg.MsgUpdateResponse> getMsgUpdateMethod;
    if ((getMsgUpdateMethod = MsgServiceGrpc.getMsgUpdateMethod) == null) {
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgUpdateMethod = MsgServiceGrpc.getMsgUpdateMethod) == null) {
          MsgServiceGrpc.getMsgUpdateMethod = getMsgUpdateMethod =
              io.grpc.MethodDescriptor.<sentinel.provider.v2.Msg.MsgUpdateRequest, sentinel.provider.v2.Msg.MsgUpdateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgUpdate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.provider.v2.Msg.MsgUpdateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.provider.v2.Msg.MsgUpdateResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void msgRegister(sentinel.provider.v2.Msg.MsgRegisterRequest request,
        io.grpc.stub.StreamObserver<sentinel.provider.v2.Msg.MsgRegisterResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMsgRegisterMethod(), responseObserver);
    }

    /**
     */
    default void msgUpdate(sentinel.provider.v2.Msg.MsgUpdateRequest request,
        io.grpc.stub.StreamObserver<sentinel.provider.v2.Msg.MsgUpdateResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
    ...
    /**
     */
    public void msgRegister(sentinel.provider.v2.Msg.MsgRegisterRequest request,
        io.grpc.stub.StreamObserver<sentinel.provider.v2.Msg.MsgRegisterResponse> responseObserver) {
    ...
    /**
     */
    public void msgUpdate(sentinel.provider.v2.Msg.MsgUpdateRequest request,
        io.grpc.stub.StreamObserver<sentinel.provider.v2.Msg.MsgUpdateResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MsgServiceBlockingStub
    ...
    /**
     */
    public sentinel.provider.v2.Msg.MsgRegisterResponse msgRegister(sentinel.provider.v2.Msg.MsgRegisterRequest request) {
    ...
    /**
     */
    public sentinel.provider.v2.Msg.MsgUpdateResponse msgUpdate(sentinel.provider.v2.Msg.MsgUpdateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MsgServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sentinel.provider.v2.Msg.MsgRegisterResponse> msgRegister(
        sentinel.provider.v2.Msg.MsgRegisterRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sentinel.provider.v2.Msg.MsgUpdateResponse> msgUpdate(
        sentinel.provider.v2.Msg.MsgUpdateRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MSG_REGISTER:
          serviceImpl.msgRegister((sentinel.provider.v2.Msg.MsgRegisterRequest) request,
              (io.grpc.stub.StreamObserver<sentinel.provider.v2.Msg.MsgRegisterResponse>) responseObserver);
          break;
        case METHODID_MSG_UPDATE:
          serviceImpl.msgUpdate((sentinel.provider.v2.Msg.MsgUpdateRequest) request,
              (io.grpc.stub.StreamObserver<sentinel.provider.v2.Msg.MsgUpdateResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              sentinel.provider.v2.Msg.MsgRegisterRequest,
              sentinel.provider.v2.Msg.MsgRegisterResponse>(
                service, METHODID_MSG_REGISTER)))
        .addMethod(
          getMsgUpdateMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              sentinel.provider.v2.Msg.MsgUpdateRequest,
              sentinel.provider.v2.Msg.MsgUpdateResponse>(
  ...
  private static abstract class MsgServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return sentinel.provider.v2.Msg.getDescriptor();
    }
